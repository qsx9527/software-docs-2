---
title: "jtop"
description: "AIBOX-3588S jtop 文档。"
---
...
* 烧录过程中会格式化 AIBOX-3588S 内置的存储设备，重要数据请先备份。
...
## AIBOX-3588S 进入烧录模式
* AIBOX-3588S 先断电
* 使用 Type-C 数据线连接 AIBOX-3588S 的 OTG 口和 PC 端
* 长按 AIBOX-3588S 的 Recovery 键
* AIBOX-3588S 供电
* 释放 AIBOX-3588S 的 Recovery 键
* 检查 AIBOX-3588S 是否进入 Recovery 模式

---
title: "使用USB线缆升级固件"
description: "AIBOX-3588S 使用USB线缆升级固件文档。"
---
...
## 准备工具
* AIBOX-3588S
* [固件](https://www.t-firefly.com/doc/download/324.html#other_912)
* 主机
* 良好的Type-C 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://www.t-firefly.com/doc/download/324.html#other_912)处下载公版固件（统一固件）。固件文件一般有两种：
...
下载 [Release_DriverAssistant.zip](https://www.t-firefly.com/doc/download/324.html#other_572)，解压，然后运行里面的 DriverInstall.exe 。为了所有设备都使用更新的驱动，请先选择`驱动卸载`，然后再选择`驱动安装`。
<center>
...
### Linux操作系统
Linux 下无须安装设备驱动
* [Linux_Upgrade_Tool](https://www.t-firefly.com/doc/download/324.html#other_571)工具

下载 [Linux_Upgrade_Tool](https://www.t-firefly.com/doc/download/324.html#other_571), 并按以下方法安装到系统中，方便调用：

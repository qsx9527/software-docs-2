...
RK182X开发套件 可以使用 Type-C 线连接到 PC 机进行串口调试：

![](../../../gs1-n2_img/AIO-GS1N2-RK182X/type-c_connection.png)

请注意，如果需要开启 Type-C 的 debug 口功能，需要把相应的拨码开关拨到指定的位置：

![](../../../gs1-n2_img/AIO-GS1N2-RK182X/debug_switch.png)

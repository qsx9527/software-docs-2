...
（5）此时在智能手机就能发现 AIO-1684XJD4 蓝牙设备，手机点击后就能配对上去：
...
在 Linux 中需要用到 Obex 服务，首先 AIO-1684XJD4 根据前面的步骤连接好蓝牙设备，然后开启 Obex 守护进程，并设置接收的目录为 `/home/linaro/`：
...
（5）查看 AIO-1684XJD4 的 `/home/linaro/`目录有 `test.txt` 文件：

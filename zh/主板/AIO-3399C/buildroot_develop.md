---
title: "Buildroot 开发"
description: "AIO-3399C Buildroot 开发文档。"
---
...
* [《编译 Buildroot 固件》](buildroot_compile.md)
...
* 解压
  ...
  软件包会解压在 `output/rockchip_rk3399/build/<package>-<version>` 目录下。
...
* 安装
  ...
  编译完成后，会将需要的编译生成文件拷贝到 `output/rockchip_rk3399/target/` 目录。

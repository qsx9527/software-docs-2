...
description: "AIO-3399C 创建 Ubuntu 根文件系统文档。"
---
...
AIO-3399C Ubuntu 根文件系统是基于 Ubuntu base 16.04 来创建的。用户可以到 [ubuntu cdimg](http://cdimage.ubuntu.com/ubuntu-base/releases/16.04/release/) 下载，选择下载 `ubuntu-base-16.04.1-base-arm64.tar.gz`。

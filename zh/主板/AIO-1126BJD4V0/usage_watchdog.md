---
title: "Watchdog 使用"
description: "AIO-1126BJD4V0 Watchdog 使用文档。"
---
...
本章节主要介绍 AIO-1126BJD4V0 开发板内部看门狗的使用。


## DTS配置

AIO-1126BJD4V0的 watchdog 的 DTS 节点在 `kernel-6.1/arch/arm64/boot/dts/rockchip/rv1126b.dtsi` 文件中定义，如下所示：

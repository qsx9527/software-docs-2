---
title: "Buildroot 开发"
description: "AIO-1126BJD4V0 Buildroot 开发文档。"
---
...
打开配置菜单 `make menuconfig`，通过设置 `BR2_ROOTFS_OVERLAY` 选项，添加用于覆盖的根目录。对于 RV1126B，默认已添加了目录 `board/rockchip/rk356x/fs-overlay/`。

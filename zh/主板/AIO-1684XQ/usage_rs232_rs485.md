...
description: "AIO-1684XQ RS485/RS232 使用文档。"
---

## RS485

AIO-1684XQ 有一个 RS485 接口，设备名称为 `/dev/ttyS2`，支持全双工，默认波特率为 `9600`。
...
除了 RS485，AIO-1684XQ 还有一个 RS232 接口，设备名称为 `/dev/ttyS1`，支持全双工，默认波特率为 `115200`。

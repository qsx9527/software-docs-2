---
title: "远程桌面 X11VNC"
description: "AIO-1684XQ 远程桌面 X11VNC文档。"
---
...
![](../../../bm1684_img/AIO-1684XQ/vnc-01.png)

（3）输入 AIO-1684XQ 的 `$bm1684_ip:0` 地址：

![](../../../bm1684_img/AIO-1684XQ/ubuntu-vnc-02.png)

（4）点击linao用户名右侧的圆形按钮，选择xfce， 输入用户与密码，均为 `linaro`：

![](../../../bm1684_img/AIO-1684XQ/ubuntu-vnc-03.png)

（5）成功进入 xfce4 桌面：

![](../../../bm1684_img/AIO-1684XQ/ubuntu-vnc-04.png)

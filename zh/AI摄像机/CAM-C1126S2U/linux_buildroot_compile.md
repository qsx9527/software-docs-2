...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rv1126_defconfig # u-boot 配置文件
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rv1126_firefly_defconfig # kernel 配置文件
# Kernel dts
export RK_KERNEL_DTS=rv1126-firefly-ai-cam-mipi101-BSD1218-A101KL68.dts # dts 文件
# Buildroot config

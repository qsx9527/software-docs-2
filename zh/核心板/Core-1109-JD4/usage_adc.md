...
Core-1109-JD4 开发板上的 AD 接口有两种，分别为：温度传感器 (Temperature Sensor)、逐次逼近ADC (Successive Approximation Register)。其中：
...
Core-1109-JD4 SAR-ADC 的 DTS 节点在 `kernel/arch/arm/boot/dts/rv1126.dtsi` 文件中定义，如下所示：

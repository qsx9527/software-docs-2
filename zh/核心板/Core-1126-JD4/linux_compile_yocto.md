...
```bash
MACHINE=aio-1126-jd4 bitbake core-image-minimal
MACHINE=aio-1126-jd4 bitbake core-image-minimal-xfce
MACHINE=aio-1126-jd4 bitbake core-image-x11
MACHINE=aio-1126-jd4 bitbake core-image-sato
```
...
```bash
MACHINE=aio-1126-jd4 bitbake core-image-weston
```
...
```bash
MACHINE=aio-1126-jd4 bitbake core-image-minimal -c clean
MACHINE=aio-1126-jd4 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-1126-jd4 bitbake linux-rockchip
        
# u-boot
MACHINE=aio-1126-jd4 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-1126-jd4 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-1126-jd4 bitbake rockchip-librga
        
# 参看更多编译对象
MACHINE=aio-1126-jd4 bitbake -s
```
...
```bash
MACHINE=aio-1126-jd4 bitbake <target> <paramater>
# e.g
MACHINE=aio-1126-jd4 bitbake u-boot-rockchip -c clean
MACHINE=aio-1126-jd4 bitbake u-boot-rockchip
```

...
## Installation
Note: The system firmware of GS1-N2 has preconfigured FireflyChat and imported the basic model. You can use it directly.If FireflyChat does not exist in the firmware, you can download the corresponding [AI firmware](https://en.t-firefly.com/doc/download/333.html) or install FireflyChat yourself.
...
After obtaining the installation package, transfer it to GS1-N2 and run the following command to install it:
...
After obtaining the model file, transfer it to GS1-N2 and run the following command to import it:

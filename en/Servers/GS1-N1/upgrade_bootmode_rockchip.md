...
The AIBOX-3576 is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.
...
*   [Firmware download link](https://en.t-firefly.com/doc/download/342.html)

...
You can use an RS232 to USB adapter to connect AIBOX-3576 to a PC for serial port debugging:

![](../../../gs1-n2_img/GS1-N1/rs232_connection.png)

### Serial parameter configuration

GS1-N1 uses the following serial port parameters:
...
**Note:** The default baud rate for GS1-N1 is 115200.
...
AIBOX-3576 DEBUG port:

![](../../../gs1-n2_img/GS1-N1/debug_connection.png)

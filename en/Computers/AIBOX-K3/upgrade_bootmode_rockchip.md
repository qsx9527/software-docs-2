...
The AIBOX-K3 is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIBOX-K3 has a flexible startup mode. Generally, the AIBOX-K3 development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://en.t-firefly.com/doc/download/386.html)


## Upgrade method
AIBOX-K3 supports firmware update through the following two methods:
...
AIBOX-K3 has three startup modes:

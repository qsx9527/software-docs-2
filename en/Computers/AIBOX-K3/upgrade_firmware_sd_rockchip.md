...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://en.t-firefly.com/doc/download/338.html#other_499)
## Operation Steps
...
* Choose firmware we want to upgrade into the AIBOX-K3
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../aibox_img/AIBOX-K3/upgrade_firmware_sd_tool_zh.png)

---
title: "DISPLAY usage"
description: "AIBOX-186 DISPLAY usage documentation."
---

# DISPLAY usage

The AIBOX-186 features an HDMI interface (supports 4K\@60fps) and a MIPS DSI interface (maximum output capability of 1440P (2560 \* 1440)@60fps,[The interface location is shown in the figure](interface_definition.html#zheng-ji-jie-kou-ding-yi)  。
...
After booting, the AIBOX-186 does not have a built-in desktop environment and only runs a display program:

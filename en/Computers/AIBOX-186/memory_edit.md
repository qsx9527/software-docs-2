...
Obtain the memory allocation tool compressed package from the [download center] and transfer it to AIBOX-186. Execute the following command to unpack the compressed package:

---
title: "Introduction"
description: "AIBOX-3588 Introduction documentation."
---
...
The AIBOX-3588 comes pre-installed with Linux. If the user wants to run other operating systems, the corresponding firmware needs to be flashed onto the motherboard.

The AIBOX-3588 offers flexible boot options. Generally, unless there is hardware damage, the AIBOX-3588 development board will not become bricked.
...
* [Download](https://en.t-firefly.com/doc/download/292.html#other_705)

## Upgrade Method

AIBOX-3588 supports firmware upgrades via the following methods:
...
AIBOX-3588 Load the system from the following storage:
...
AIBOX-3588 has the following boot modes:

---
title: "Serial debug"
description: "AIBOX-3588 Serial debug documentation."
---
...
You can use an RS232 to USB adapter to connect AIBOX-3588 to a PC for serial port debugging:

![](../../../aibox_img/AIBOX-3588/rs232_connection.png)

### Serial parameter configuration

AIBOX-3588 uses the following serial port parameters:
...
**Note:** The default baud rate for AIBOX-3588 is 115200.
...
AIBOX-3588 DEBUG port:

![](../../../aibox_img/AIBOX-3588/debug_connection.png)

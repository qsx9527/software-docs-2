...
* When flashing, AIBOX-3588S will format the internal storage device, please back up important data first.
...
## Put AIBOX-3588S into Force Recovery Mode
* Ensure that AIBOX-3588S is powered off
* Connect AIBOX-3588S and PC using TypeC
* Press and hold down AIBOX-3588S Recovery-Key
* AIBOX-3588S power on
* Release AIBOX-3588S Recovery-Key
* Check AIBOX-3588S Recovery Mode
    * use `lsusb` comand, AIBOX-3588S is in Force Recovery Mode if you see the message: `Bus <bbb> Device <ddd>: ID 0955: <nnnn> Nvidia Corp.`

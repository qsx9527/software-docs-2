...
description: "AIBOX-3588S Check if miniforge3 and conda are installed, and if they are, you can skip this section. documentation."
---

### 1.RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto AIBOX-3588S.
...
```
##### 3.1.2 Deploy And Run The RKLLM Model On AIBOX-3588S.
...
./build-linux.sh
```
###### 3.1.2.3 Running Inference On AIBOX-3588S

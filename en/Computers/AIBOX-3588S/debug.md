---
title: "Serial debug"
description: "AIBOX-3588S Serial debug documentation."
---
...
You can use an RS232 to USB adapter to connect AIBOX-3588S to a PC for serial port debugging:

![](../../../aibox_img/AIBOX-3588S/rs232_connection.png)

### Serial parameter configuration

AIBOX-3588S uses the following serial port parameters:
...
**Note:** The default baud rate for AIBOX-3588S is 115200.
...
AIBOX-3588S DEBUG port:

![](../../../aibox_img/AIBOX-3588S/debug_connection.png)

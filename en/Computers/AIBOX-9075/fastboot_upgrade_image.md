...
While device is running normally, connect device's download port with PC through Type-A USB cable, then run this command on device terminal or debug console:

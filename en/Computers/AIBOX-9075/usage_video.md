...
Use gst-inspect to list available media plugins, these v4l plugins have hardware acceleration.
...
For example, play h264 video, use v4l2h264dec:
```bash
...
For example, encode h264 stream use v4l2h264enc:
```bash

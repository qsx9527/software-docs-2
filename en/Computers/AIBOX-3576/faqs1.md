---
title: "jtop"
description: "AIBOX-3576 jtop documentation."
---
...
* When flashing, AIBOX-3576 will format the internal storage device, please back up important data first.
...
## Put AIBOX-3576 into Force Recovery Mode
* Ensure that AIBOX-3576 is powered off
* Connect AIBOX-3576 and PC using TypeC
* Press and hold down AIBOX-3576 Recovery-Key
* AIBOX-3576 power on
* Release AIBOX-3576 Recovery-Key
* Check AIBOX-3576 Recovery Mode
    * use `lsusb` comand, AIBOX-3576 is in Force Recovery Mode if you see the message: `Bus <bbb> Device <ddd>: ID 0955: <nnnn> Nvidia Corp.`

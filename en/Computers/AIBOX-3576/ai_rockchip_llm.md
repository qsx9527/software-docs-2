...
description: "AIBOX-3576 Check if miniforge3 and conda are installed, and if they are, you can skip this section. documentation."
---

### 1.RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto AIBOX-3576.

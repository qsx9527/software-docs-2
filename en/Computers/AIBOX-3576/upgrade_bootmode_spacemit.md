...
The AIBOX-3576 comes pre-installed with Linux. If the user wants to run other operating systems, the corresponding firmware needs to be flashed onto the motherboard.

The AIBOX-3576 offers flexible boot options. Generally, unless there is hardware damage, the AIBOX-3576 development board will not become bricked.
...
* [Download](https://en.t-firefly.com/doc/download/page/id/241.html)

## Upgrade Method

AIBOX-3576 supports firmware upgrades via the following methods:
...
AIBOX-3576 Load the system from the following storage:
...
AIBOX-3576 has the following boot modes:

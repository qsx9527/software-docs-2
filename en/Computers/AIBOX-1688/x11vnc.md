...
description: "AIBOX-1688 Remote Desktop X11VNC documentation."
---
...
![](../../../bm1688_img/AIBOX-1688/vnc-01.png)

(3) Enter the `$bm1688_ip:0` address of AIBOX-1688:

![](../../../bm1688_img/AIBOX-1688/ubuntu-vnc-02.png)

(4) Click the circular button next to the linaro username, select xfce, and enter the username and password, both are `linaro`:

![](../../../bm1688_img/AIBOX-1688/ubuntu-vnc-03.png)

(5) Successfully enter the xfce4 desktop:

![](../../../bm1688_img/AIBOX-1688/ubuntu-vnc-04.png)
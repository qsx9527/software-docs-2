...
description: "AIBOX-1684 Network IP configuration documentation."
---

# Network IP configuration


By default, AIBOX-1684 has a dynamic IP set for ethernet port 0, and a static IP set for ethernet port 1. These configurations are implemented through the `/etc/netplan/01-netcfg.yaml` file in the system.

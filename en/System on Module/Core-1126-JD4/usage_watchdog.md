...
Core-1126-JD4 development board includes an integrated, on-chip watchdog. This section will show you how to manage it.

## DTS configuration

The watchdog node of Core-1126-JD4 defined in `kernel/arch/arm/boot/dts/rv1126.dtsi`, as showm below:

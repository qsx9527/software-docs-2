...
&gmac {
        ...
        assigned-clock-parents = <&cru CLK_GMAC_SRC_M1>, <&cru RGMII_MODE_CLK>;//Core board and baseboard use this
        //assigned-clock-parents = <&cru CLK_GMAC_SRC_M0>, <&cru RGMII_MODE_CLK>;//Cluster server R1 Use this
        assigned-clock-rates = <125000000>, <0>, <25000000>;

        pinctrl-names = "default";
        pinctrl-0 = <&rgmiim1_miim &rgmiim1_bus2 &rgmiim1_bus4 &clkm1_out_ethernet>;
        //pinctrl-0 = <&rgmiim0_pins &clk_out_ethernetm0_pins>;//Cluster server R1 uses

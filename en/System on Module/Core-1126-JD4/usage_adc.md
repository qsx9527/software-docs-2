...
Core-1126-JD4 There are two AD interfaces on the development board: temperature sensor (Temperature Sensor) and successive approximation ADC (Successive Approximation Register). Among them:
...
### Configure DTS nodes
The SAR-ADC nodes of Core-1126-JD4 defined in `kernel/arch/arm/boot/dts/rv1126.dtsi` file, as showm below:

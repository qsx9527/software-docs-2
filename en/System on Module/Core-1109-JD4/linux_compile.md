...
Download Firefly_Linux_SDK sub-volume compressed package: [Linux SDK](https://en.t-firefly.com/doc/download/87.html)
...
* Download: [Debian rootfs(32-bit)](https://en.t-firefly.com/doc/download/87.html)，put in SDK path

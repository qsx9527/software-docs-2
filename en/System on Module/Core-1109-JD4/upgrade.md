...
![](../../../rv1126_img/rkdevtool_loader.png)

* 导入升级使用的配置文件` core-rv1126-jd4.cfg`。

![](../../../rv1126_img/rkdevtool_setting.png)

* 选择好要烧写分区固件的路径。

![](../../../rv1126_img/rkdevtool_path.png)

* 点击`执行`等待升级完成。

![](../../../rv1126_img/rkdevtool_start.png)

* 修改` config.ini `文件可以设置语言。

![](../../../rv1126_img/language.png)
...
![](../../../rv1126_img/SD_Firmware_Tool_zh.png)

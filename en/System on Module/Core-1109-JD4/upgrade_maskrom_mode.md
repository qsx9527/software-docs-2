...
2. Use tweezers to short the two test points on Core-1109-JD4 (both as shown in the figure below)
3. Plug the device into the power supply and power it on

* The following are the two test points on Core-1109-JD4
![](../../../rv1126_img/Core-1109-JD4/upgrade_maskrom_test_points_core.png)

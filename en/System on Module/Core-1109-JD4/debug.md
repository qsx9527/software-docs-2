...
<font color=#ff0000>**Note:** The default baud rate of Core-1109-JD4 is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
Core-1109-JD4 serial port connection diagram:

![](../../../rv1126_img/Core-1109-JD4/debug_connection.jpg)

## Parameter Setting

Core-1109-JD4 use the following serial parameters:

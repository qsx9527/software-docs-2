...
```bash
MACHINE=CQ38W-3576 bitbake core-image-minimal
MACHINE=CQ38W-3576 bitbake core-image-minimal-xfce
MACHINE=CQ38W-3576 bitbake core-image-x11
MACHINE=CQ38W-3576 bitbake core-image-sato
```
...
```bash
MACHINE=CQ38W-3576 bitbake core-image-weston
```
...
```bash
MACHINE=CQ38W-3576 bitbake core-image-minimal -c clean
MACHINE=CQ38W-3576 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=CQ38W-3576 bitbake linux-rockchip
        
# u-boot
MACHINE=CQ38W-3576 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=CQ38W-3576 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=CQ38W-3576 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=CQ38W-3576 bitbake -s
```
...
```bash
MACHINE=CQ38W-3576 bitbake <target> <paramater>
# e.g
MACHINE=CQ38W-3576 bitbake u-boot-rockchip -c clean
MACHINE=CQ38W-3576 bitbake u-boot-rockchip
```

...
```bash
./build.sh firefly_rk3576_ext_icore-3576q38_buildroot_defconfig
```
...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rk3576_defconfig # u-boot configuration file
# Kernel defconfig
export RK_KERNEL_DEFCONFIG= # kernel configuration file
# Kernel dts
export RK_KERNEL_DTS=rk3576-firefly-ext-icore-3576q38 # dts file
# Buildroot config

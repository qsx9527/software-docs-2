...
<font color=#ff0000>**Note:** The default baud rate of CQ38W-3576 is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
CQ38W-3576 serial port connection diagram:

![](../../../rk3576_img/CQ38W-3576/debug_connection.jpg)

## Parameter Setting

CQ38W-3576 use the following serial parameters:

...
<font color=#ff0000>**Note:** The default baud rate of C40PL is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
C40PL serial port connection diagram:

![](../../../rv1126_img/C40PL/debug_connection.jpg)

## Parameter Setting

C40PL use the following serial parameters:

...
CAM-C1126S2U development board includes an integrated, on-chip watchdog. This section will show you how to manage it.

## DTS configuration

The watchdog node of CAM-C1126S2U defined in `kernel/arch/arm/boot/dts/rv1126.dtsi`, as showm below:

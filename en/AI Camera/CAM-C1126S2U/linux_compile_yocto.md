...
```bash
MACHINE=cam-c1126s2u bitbake core-image-minimal
MACHINE=cam-c1126s2u bitbake core-image-minimal-xfce
MACHINE=cam-c1126s2u bitbake core-image-x11
MACHINE=cam-c1126s2u bitbake core-image-sato
```
...
```bash
MACHINE=cam-c1126s2u bitbake core-image-weston
```
...
```bash
MACHINE=cam-c1126s2u bitbake core-image-minimal -c clean
MACHINE=cam-c1126s2u bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=cam-c1126s2u bitbake linux-rockchip
        
# u-boot
MACHINE=cam-c1126s2u bitbake u-boot-rockchip
        
# rkmpp
MACHINE=cam-c1126s2u bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=cam-c1126s2u bitbake rockchip-librga
        
# See more compilation objects
MACHINE=cam-c1126s2u bitbake -s
```
...
```bash
MACHINE=cam-c1126s2u bitbake <target> <paramater>
# e.g
MACHINE=cam-c1126s2u bitbake u-boot-rockchip -c clean
MACHINE=cam-c1126s2u bitbake u-boot-rockchip
```

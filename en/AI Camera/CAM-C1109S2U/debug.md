...
<font color=#ff0000>**Note:** The default baud rate of CAM-C1109S2U is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
CAM-C1109S2U serial port connection diagram:

![](../../../rv1126_img/CAM-C1109S2U/debug_connection.jpg)

## Parameter Setting

CAM-C1109S2U use the following serial parameters:

...
The CAM-C1109S2U is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

CAM-C1109S2U has a flexible startup mode. Generally, the CAM-C1109S2U development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://en.t-firefly.com/doc/download/page/id/85.html)


## Upgrade method
CAM-C1109S2U supports firmware update through the following two methods:
...
CAM-C1109S2U loads the system from the following memory:

* eMMC interface

## Boot mode

CAM-C1109S2U has three startup modes:

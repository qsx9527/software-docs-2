...
2. Use tweezers to short the two test points on CAM-C1109S2U (both as shown in the figure below)
3. Plug the device into the power supply and power it on

* The following are the two test points on CAM-C1109S2U
![](../../../rv1126_img/CAM-C1109S2U/upgrade_maskrom_test_points_core.png)

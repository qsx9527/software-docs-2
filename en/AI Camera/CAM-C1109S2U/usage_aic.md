...
AIC (Android in Container) means runing Android inside a container on Linux. RV1126_RV1109 Linux can use docker to run Android and support running multiple Androids at the same time.
...
One RV1126_RV1109 using AIC running two Genshin Impact with highest graphic setting at the same time can reach 35+ fps:
![](../../../rv1126_img/common/aic_ys_performance.png)
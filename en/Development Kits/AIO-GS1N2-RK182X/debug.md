...
You can use an RS232 to USB adapter to connect RK182X开发套件 to a PC for serial port debugging:

![](../../../gs1-n2_img/AIO-GS1N2-RK182X/rs232_connection.png)

### Serial parameter configuration

AIO-GS1N2-RK182X uses the following serial port parameters:
...
![](../../../gs1-n2_img/debug_set_MobaXterm1.PNG)
![](../../../gs1-n2_img/debug_set_MobaXterm2.PNG)
...
**Note:** The default baud rate for AIO-GS1N2-RK182X is 115200.
...
RK182X开发套件 DEBUG port:

![](../../../gs1-n2_img/AIO-GS1N2-RK182X/debug_connection.png)

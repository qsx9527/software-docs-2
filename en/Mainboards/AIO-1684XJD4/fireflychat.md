...
After obtaining the installation package, transfer it to AIO-1684XJD4 and run the following command to install it:
...
After obtaining the model file, transfer it to AIO-1684XJD4 and run the following command to import it:

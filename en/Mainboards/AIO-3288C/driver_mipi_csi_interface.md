...
description: "AIO-3288C Driver MIPI CSI Interface documentation."
---
...
In the development board, except for CIF_POWER and DVP_POWER which shall be set on DTS and driver, the other pins shall be set on cam_board_rk3288_aio-3288c.xml.